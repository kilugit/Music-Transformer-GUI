...
class MusicTransformerGUI:
    ...
    def _build_generate_tab(self):
        ...
        # Column 1
        r = 0
        ttk.Label(adv, text="Number of Segments:").grid(row=r, column=0, sticky="w", padx=5, pady=6)
        self.segments_var = tk.IntVar(value=4)
        ttk.Entry(adv, textvariable=self.segments_var, width=12).grid(row=r, column=1, sticky="w", padx=5, pady=6)
        ...
        r += 1
        ttk.Label(adv, text="Playback Speed:").grid(row=r, column=0, sticky="w", padx=5, pady=6)
    ...
    def _run_generate(self, model_path, save_path):
        ...
        cmd.extend(["-n", str(self.segments_var.get())])
